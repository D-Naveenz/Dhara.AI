...
/// 1,536 bytes: 384 dimensions multiplied by 4 bytes per dimension.
/// </summary>
...
public readonly struct EmbeddingF32 : IBufferedEmbedding<EmbeddingF32>
{
    ...
    /// similar meaning should produce vectors that point in a similar direction.
    /// </summary>
    ...
    /// multiplied by 4 because each <see cref="float"/> is 4 bytes.
    /// </returns>
    ...
    /// </param>
    /// <returns>An embedding that stores the model output as 32-bit floating-point values.</returns>
